<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Intermedio - XM.aspx.cs" Inherits="Othell.Intermedio___XM" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Panel ID="Panel2" runat="server" style="font-style: italic; font-family: 'Arial Narrow'; font-weight: 700; background-color: #006B3C" CssClass="auto-style86" BackColor="#006B3C">
            ...
            <h3 class="auto-style116">Filas:</h3>
            ...
            <asp:Button ID="Button1" runat="server" CssClass="auto-style115" Text="Comenzar Partida" BackColor="Black" BorderColor="Black" Font-Italic="True" Font-Names="Arial Narrow" ForeColor="White" OnClick="Button1_Click" />
            ...
            <asp:Button ID="Button2" runat="server" BackColor="Black" BorderColor="Black" CssClass="auto-style82" Font-Italic="True" ForeColor="White" OnClick="Button1_Click1" Text="Cargar Partida" />
        </asp:Panel>
    </form>
</body>
</html>
